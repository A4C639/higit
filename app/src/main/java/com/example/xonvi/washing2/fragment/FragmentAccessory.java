...
public class FragmentAccessory extends Fragment implements TopRVAdapter.MyClickListener{
    //recyclerview
    @BindView(R.id.rv_frg_accessory)RecyclerView rv_frg_accessory;
    @BindView(R.id.fl_loading_anima_accessory)FrameLayout fl_loading_anima_accessory;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frg_accessory, null);
    ...
    private void initAccessoryList()  {
        fl_loading_anima_accessory.setVisibility(View.VISIBLE);

        listPresenter.getAccessoryList()
                ...
                .subscribe(new Subscriber<List<Thing>>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        fl_loading_anima_accessory.setVisibility(View.GONE);
                    }
    ...
    private void adp(List<Thing> list) {
        ...
        rv_frg_accessory.setLayoutManager(staggeredGridLayoutManager);
        TopRVAdapter adapter = new TopRVAdapter(list);
        //初始化回掉接口
        adapter.setMyClickListener(this);
        rv_frg_accessory.setAdapter(adapter);
    }
    //回掉点击事件
    @Override
